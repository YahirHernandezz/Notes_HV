...
from notes_HernandezVivas.views import HomePageView, CreateNotaView, EditNotaView, DeleteNotaView, DetailNotaView
...
urlpatterns = [
    ...
    path('<int:pk>/', DetailNotaView.as_view(), name='detail'),
]